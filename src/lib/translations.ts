...
export const translations = {
  ...
  auth: {
    ...
    contact: {
      ...
      messagePlaceholder: 'Tell us what you\'re thinking...',
  ...
  auth: {
    ...
    hero: {
      ...
      title: 'Pembuat Diagram ',
      titleHighlight: 'Bertenaga AI',
      titleRest: '',
    ...
    contact: {
      title: 'Hubungi ',
      titleHighlight: 'Kami',
      subtitle: 'Punya pertanyaan atau ingin bekerja sama? Kami ingin mendengar dari Anda.',
      nameLabel: 'Nama',
      namePlaceholder: 'Nama Anda',
      emailLabel: 'Email',
      emailPlaceholder: 'email.anda@example.com',
      messageLabel: 'Pesan',
      messagePlaceholder: 'Ceritakan apa yang Anda pikirkan...',
      sendButton: 'Kirim Pesan',
      sending: 'Mengirim...',
      successTitle: 'Pesan Terkirim!',
      successMessage: 'Terima kasih telah menghubungi kami. Kami akan segera menghubungi Anda kembali.',
      errorTitle: 'Error',
